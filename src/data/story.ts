...
export type StoryReturnScene = 'MenuScene' | 'CampaignScene' | 'LoadoutScene' | 'WorkshopScene' | 'LetterBookScene' | 'DeliveryScene' | 'JourneyMapScene' | 'LakeScene' | 'MountainScene' | 'DesertScene';
...
export function sanitizeStoryReturnRoute(input: unknown): StoryReturnRoute {
  ...
  if (!raw || typeof raw.scene !== 'string' || !['MenuScene', 'CampaignScene', 'LoadoutScene', 'WorkshopScene', 'LetterBookScene', 'DeliveryScene', 'JourneyMapScene', 'LakeScene', 'MountainScene', 'DesertScene'].includes(raw.scene)) {
