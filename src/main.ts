...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [BootScene, MenuScene, CampaignScene, LoadoutScene, ArenaScene, GameOverScene, WorkshopScene, StoryScene, LetterBookScene, DeliveryScene, JourneyMapScene, LakeScene],
};
